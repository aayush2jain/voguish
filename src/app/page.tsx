      ...
      <div>
        <div className='h-[100vh] w-[100vw] bg-red-50'>
          ...
          <div className='flex flex-row gap-[30vw]'>
            <div className='relative mt-[10vh] pl-[10vw]'>
              <div className='h-[40vh] w-[22vw] bg-red-500  top-0 absolute z-10 rounded-3xl'>
                <img className='h-[40vh] w-[22vw] rounded-3xl' src='https://img.freepik.com/free-photo/young-girl-checked-shirt-pink-t-shirt-stretching-one-hand-as-holding-something-pointing-it-with-index-finger-looking-pretty-front-view_176474-87269.jpg?t=st=1722421948~exp=1722425548~hmac=dea21f1a0c2c797da71c47c2b7759c776c156174903d204458a90765727c6b1a&w=900' alt=""></img>
              </div>
              <div className='h-[60vh] w-[20vw] bg-white  top-0 left-[1vw] absolute rounded-3xl'></div>
            </div>
            <div className='relative mt-[10vh]'>
              <div className='h-[40vh] w-[22vw] bg-red-500 top-0 absolute z-10 rounded-3xl'>
                <img className='h-[40vh] w-[22vw] rounded-3xl' src='https://img.freepik.com/free-photo/portrait-handsome-confident-stylish-hipster-lambersexual-modelman-dressed-jacket-jeans-fashion-male-posing-studio-near-grey-wall_158538-23976.jpg?t=st=1722422130~exp=1722425730~hmac=61b990c8121ca2e83d4b61281d43000dfab80579bfeaa11079b08dd5631ef685&w=826' alt=""></img>
              </div>
              <div className='h-[60vh] w-[20vw] bg-white top-0 left-[1vw] absolute rounded-3xl'></div>
            </div>
            <div className='relative mt-[10vh]'>
              <div className='h-[40vh] w-[22vw] bg-red-500 top-0 absolute z-10 rounded-3xl'>
                <img className='h-[40vh] w-[22vw] rounded-3xl' src='https://img.freepik.com/free-photo/young-female-model-sleeping-underwear_1303-19352.jpg?t=st=1722422169~exp=1722425769~hmac=35685ddb94208c40311037502cb26376426b3cbc33b27eb848f6eb55e760543b&w=900' alt=""></img>
              </div>
              <div className='h-[60vh] w-[20vw] bg-white  top-0 left-[1vw] absolute rounded-3xl'></div>
            </div>
          </div>
